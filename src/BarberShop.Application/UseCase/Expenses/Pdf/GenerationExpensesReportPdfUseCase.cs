using BarberShop.Application.UseCase.Expenses.Pdf.Colors;
using BarberShop.Application.UseCase.Expenses.Pdf.Fonts;
...
public class GenerationExpensesReportPdfUseCase : IGenerationExpensesReportPdfUseCase
{
    ...
    public GenerationExpensesReportPdfUseCase(IExpensesReadOnlyRepository repository)
    {
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Barbearia";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "barbershop.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, BarberShop!");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        var title = string.Format(ResourceReportGenerationMessages.TOTAL_REVENUE, month.ToString("Y"));
